...
export const goodCategories = [
  { category: 'Animaux', isValue: 0, followByUser: false },
  { category: 'Beauté & bien être', isValue: 1, followByUser: false },
  { category: 'Décoration', isValue: 2, followByUser: false },
  { category: 'Entretien', isValue: 3, followByUser: false },
  { category: 'Fêtes & évènements', isValue: 4, followByUser: false },
  {
    category: 'High tech & fournitures de bureau',
    isValue: 5,
    followByUser: false,
  },
  { category: 'Matériel de jardin', isValue: 6, followByUser: false },
  { category: 'Matériel de sport', isValue: 7, followByUser: false },
  { category: 'Meubles', isValue: 8, followByUser: false },
  { category: 'Mode & accessoires', isValue: 9, followByUser: false },
  { category: 'Outillage et travaux', isValue: 10, followByUser: false },
  { category: 'Pièces auto/moto', isValue: 11, followByUser: false },
];

export const serviceCategories = [
  { category: 'Mode/beauté', isValue: 0, followByUser: false },
  { category: 'Cours & formations', isValue: 1, followByUser: false },
  { category: 'Bricolage & travaux', isValue: 2, followByUser: false },
  {
    category: 'Déménagement & manutention',
    isValue: 3,
    followByUser: false,
  },
  {
    category: 'Dépannage & réparation de matériel',
    isValue: 4,
    followByUser: false,
  },
  {
    category: 'Entretien & réparation auto/moto',
    isValue: 5,
    followByUser: false,
  },
  { category: 'Garde d’enfants', isValue: 6, followByUser: false },
  {
    category: 'Garde/promenade d’animaux',
    isValue: 7,
    followByUser: false,
  },
  { category: 'Jardinage & piscine', isValue: 7, followByUser: false },
  { category: 'Ménage à domicile', isValue: 9, followByUser: false },
  {
    category: 'Restauration & réception',
    isValue: 10,
    followByUser: false,
  },
  { category: 'Services à la personne', isValue: 11, followByUser: false },
  { category: 'Santé & bien être', isValue: 12, followByUser: false },
];
